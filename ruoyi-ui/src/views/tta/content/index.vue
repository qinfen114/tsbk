...
<script>
import { listContent, getContent, delContent, addContent, updateContent } from "@/api/tta/content";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('tta/content/export', {
        ...this.queryParams
